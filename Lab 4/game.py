...
def menu(exits):
    ...
    a name of an exit where sehe wants to go. The players's input is normalised
    ...
    # Repeat until the player enter a valid choicewhile True:
        # COMPLETE THIS PART
    while True:
        # Display menu
        print_menu(exits)
        # Read player's input
        player_input = input("Please enter a direction: ")
        # Normalise the input
